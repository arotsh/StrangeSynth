...
var routes = [
    ...
    { path: 'preloader', loadChildren: './preloader/preloader.module#PreloaderPageModule' },
];
...
module.exports = __webpack_require__(/*! /Users/admin/Desktop/PROJECTS/Archive copy/src/main.ts */"./src/main.ts");
